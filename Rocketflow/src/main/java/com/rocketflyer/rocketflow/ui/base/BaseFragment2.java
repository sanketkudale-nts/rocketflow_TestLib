...
public abstract class BaseFragment2<T extends ViewDataBinding, V extends BaseViewModel> extends Fragment {

    private final String TAG = BaseFragment2.class.getName();
