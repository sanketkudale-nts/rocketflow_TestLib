package com.rocketflyer.rocketflow.data.local.prefs
...
class GetUserLocationWorker(var context: Context, workerParams: WorkerParameters) : Worker(context, workerParams), MyPlaceNavigator {
